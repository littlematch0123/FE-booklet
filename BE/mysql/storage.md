...
&emsp;&emsp;注意：ROW_COUNT()函数用来得到插入、删除以及更新的被影响的记录总数
...
&emsp;&emsp;事务特性包括：原子性(Atomicity)、一致性(Consistency)、隔离性(Isolation)、持久性(Durability)，简写为ACID
