...
　　[H](http://www.cnblogs.com/xiaohuochai/p/6392010.html)[TTP](http://www.cnblogs.com/xiaohuochai/p/6392010.html)不是基于特定语言的，是一个通用的应用层协议，不同语言有不同的实现细节，但是万变不离其宗，思想是相同的。NodeJS作为一个宿主运行环境，以[JavaScript](http://www.cnblogs.com/xiaohuochai/p/5613593.html)为宿主语言，它也有自己实现的一套标准，本文将详细介绍nodeJS中的Http模块
