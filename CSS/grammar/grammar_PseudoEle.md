...
<pre>div:first-letter{color: red;}</pre>
</div>
...
<div class="cnblogs_code">
<pre>div:first-line{color: red;}    </pre>
</div>
...
<div class="cnblogs_code">
<pre>div::selection{color: red;}</pre>
</div>
...
<div class="cnblogs_code">
<pre>content:normal;(默认)
content:&lt;string&gt;|&lt;uri&gt;|attr(&lt;identifier&gt;)</pre>
</div>
...
<div class="cnblogs_code">
<pre>quotes:'201C' '201D' '2018' '2019';//第一个值定义最外层开始引号(open-quote),第二个串定义最外层结束引号(close-quote)，第三个值定义次外层开始引号，第四个值定义次外层结束引号，第五个值定义次次外层开始引号，第六个值定义次次外层结束引号&hellip;&hellip;</pre>
</div>
...
　　关于counter属性值，详见[深入理解CSS计数器](http://www.cnblogs.com/xiaohuochai/p/5018519.html)
