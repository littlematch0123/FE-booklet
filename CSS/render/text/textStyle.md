# CSS中常见的6种文本样式
 ...
 　　CSS文本样式是相对于内容进行的样式修饰。由于在[层叠关系](http://www.cnblogs.com/xiaohuochai/p/5304619.html#anchor2)中，内容要高于背景。所以文本样式相对而言更加重要。有些人对文本和[字体样式](http://www.cnblogs.com/xiaohuochai/p/4986285.html)之间的不同不太了解，简单地讲，文本是内容，而字体则用于显示这个内容。本文将详细介绍文本相关样式
