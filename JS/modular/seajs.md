...
　　这个require()方法的实现和功能都特别类似于[CommonJS](http://www.cnblogs.com/xiaohuochai/p/6847939.html#anchor6)中的require()方法。或许，有人会有疑惑，require()不是一个同步方法吗？在CommonJS中是的，在seaJS中也可以这么说，但并不完整。更合理的说法应该是，模块内的同步加载，实际表现为对模块a进行预下载
