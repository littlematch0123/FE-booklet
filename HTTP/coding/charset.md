...
　　编码上下文始终被设置为4种预设的字符集之一，使用特殊的&ldquo;转义序列&rdquo; (escape sequence)在字符集之间切换。iso-2022-jp的初始状态使用US-ASCII字符集，使用3个字节的转义序列可以切换到JIS X 0201(JIS-Roman)字符集或大得多的JIS X 0208-1978和JIS X 0208-1983字符集
