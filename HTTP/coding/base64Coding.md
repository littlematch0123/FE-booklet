...
　　对已填充的二进制串进行编码时，任何完全填充(不包含原始数据中的位)的6位组都由特殊的第65个符号&ldquo;=&rdquo;表示。如果6位组是部分填充的，就将填充位设置为0
...
　　当然也可以使用[原生拖拽](http://www.cnblogs.com/xiaohuochai/p/5886618.html)，实现图片拖拽，在某个区域显示Base64编码的效果
