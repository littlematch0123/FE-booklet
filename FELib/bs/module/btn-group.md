...
　　在上面的代码中，.btn-group-justified &gt; .btn设置了table-cell，而table-cell是不能设置margin的，而代码中设置了-margin值，用来去除边框，显然不会生效。因此，去除重复边框的代码应该是合并表格边框&mdash;&mdash;&nbsp;border-collapse: collapse
